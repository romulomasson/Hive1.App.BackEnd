...
@Index('indique_semanal_pkey', ['id'], { unique: true })
@Entity('indique_semanal', { schema: 'logica' })
export class IndiqueSemanal {
  ...
  @Column('integer', { name: 'quantidade_indicados' })
      quantidadeIndicados: number
